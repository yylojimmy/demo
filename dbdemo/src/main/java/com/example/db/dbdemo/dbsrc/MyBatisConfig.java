...
@MapperScan(basePackages = "com.example.db.dbdemo.mapper")*/
public class MyBatisConfig {
    ...
    public DynamicDataSource dataSource(@Qualifier("myTestDbDataSource") DataSource myTestDbDataSource,
        ...
        targetDataSources.put(DatabaseType.D3306, myTestDbDataSource);
        targetDataSources.put(DatabaseType.D3307, myTestDb2DataSource);
